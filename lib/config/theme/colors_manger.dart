...
final class ColorsManger {
  static const white = Colors.white;
  static const black = Color(0xff090F1F);
  static const lightBlack = Color(0x80090F1F);
  static const extraLightOrange = Color(0xffFFDBDB);
  static const lightOrang = Color(0xffF95B1C);
  static const deepOrange = Color(0xffFF4144);
